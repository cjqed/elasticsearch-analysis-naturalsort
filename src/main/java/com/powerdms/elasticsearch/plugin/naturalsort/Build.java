...
public class Build {
    ...
    static {
        ...
        try {
            String pluginName = NaturalSortAnalysisPlugin.class.getName();
            Enumeration<URL> e = NaturalSortAnalysisPlugin.class.getClassLoader().getResources("es-plugin.properties");
